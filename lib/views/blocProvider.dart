...
//lib generic_bloc_provider https://github.com/robertohuertasm/generic_bloc_provider
...
class BlocProvider<T extends BlocBase> extends StatefulWidget {
  ...
  /// If you set
  static T of<T extends BlocBase>(BuildContext context, [bool attachContext = true]) => _BlocProvider.of(context, attachContext);
...
class _BlocProvider<T extends BlocBase> extends InheritedWidget {
  ...
  static T of<T extends BlocBase>(BuildContext context, bool attachContext) {
    late _BlocProvider<T> blocProvider;
    attachContext = false;
    if (attachContext) {
      blocProvider = context.dependOnInheritedWidgetOfExactType<_BlocProvider<T>>()!;
    } else {
      var element = context.getElementForInheritedWidgetOfExactType<_BlocProvider<T>>();
      if (element != null) {
  ...
  @override
  bool updateShouldNotify(_BlocProvider oldWidget) =>
      updateShouldNotifyOverride != null ? updateShouldNotifyOverride!(bloc, oldWidget) : oldWidget.bloc != bloc;
}
