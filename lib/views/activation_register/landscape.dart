...
class ActivationRegisterLandScape extends StatefulWidget {
  ActivationRegisterLandScape({Key? key}) : super(key: key);

  @override
  State<ActivationRegisterLandScape> createState() => _ActivationRegisterLandScapeState();
}

class _ActivationRegisterLandScapeState extends State<ActivationRegisterLandScape> {
