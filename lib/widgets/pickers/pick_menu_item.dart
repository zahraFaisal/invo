...
class PickMenuItem extends StatefulWidget {
  final List<int>? selectedIds;
  PickMenuItem({Key? key, this.selectedIds}) : super(key: key);

  @override
  _PickMenuItemState createState() => _PickMenuItemState();
}

class _PickMenuItemState extends State<PickMenuItem> {
  ...
  void initState() {
    ...
    menuItemListBloc.loadList(widget.selectedIds);
  }
                    ...
                    builder: (BuildContext context, AsyncSnapshot snapshot) {
                      return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            MenuItemList menuitem = menuItemListBloc.list.value![index];
                            return Container(
                              margin: EdgeInsets.fromLTRB(8, 0, 8, 0),
                              decoration: BoxDecoration(
                                    ...
                                    Expanded(
                                      child: Center(
                                        child: Padding(
                                          ...
                                          child: Text(
                                            Number.getNumber(menuitem.price),
                                            style: TextStyle(
                                              fontSize: 23,
                                            ),
                                          ),
                  ...
                  Container(
                    ...
                    child: ButtonTheme(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).pop(List<MenuItemList>.empty(growable: true));
                        },
                      ),
                    ),
                  ),
                  Container(
                    ...
                    child: ButtonTheme(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.of(context).pop(menuItemListBloc.list.value!.where((f) => f.isSelected).toList());
                        },
                      ),
                    ),
                  ),
